...
class AdmissionsDiscoveryTests(TestCase):
    ...
    def test_home_prioritizes_search_and_exposes_comparison_without_javascript(self):
        ...
        self.assertNotIn('class="discovery-highlights"', html)
        self.assertEqual(html.count('data-ad-slot="8829169633"'), 1)
        self.assertLess(html.index('class="manual-display-ad"'), html.index('class="discovery-coverage"'))
